# Document Management System Docs for Rastriya Banijya Bank(RBB)
1. **Navbar**: 
   - User profile:
      - My profile :
...
3. **Documents:**
     - Documents Section
       1. Add Document
          - Add Document Name, Change Document Status, Location map, Expiry Date, Language, Assign the Department, Change Document Condition, Change Document Condition, Select Security Hierarchy, Select the Checker. 
          - Document identifier
...
Note:- In CONSTANT everyone in the hierarchy can see the document
...
change default section according to banks: 
1.selectVendor.js    ---gentech-dms-api

-> default: selectedVendor = banks.bok; or banks.rbb;


2.bank.js    --- gentech-dms
